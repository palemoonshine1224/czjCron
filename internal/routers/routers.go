...
import (
	...
	"github.com/palemoonshine1224/czjCron/internal/modules/app"
	"github.com/palemoonshine1224/czjCron/internal/modules/logger"
	"github.com/palemoonshine1224/czjCron/internal/modules/utils"
	"github.com/palemoonshine1224/czjCron/internal/routers/host"
	"github.com/palemoonshine1224/czjCron/internal/routers/install"
	"github.com/palemoonshine1224/czjCron/internal/routers/loginlog"
	"github.com/palemoonshine1224/czjCron/internal/routers/manage"
	"github.com/palemoonshine1224/czjCron/internal/routers/task"
	"github.com/palemoonshine1224/czjCron/internal/routers/tasklog"
	"github.com/palemoonshine1224/czjCron/internal/routers/user"
	"github.com/rakyll/statik/fs"
	"gopkg.in/macaron.v1"

	_ "github.com/palemoonshine1224/czjCron/internal/statik"
)
...
func Register(m *macaron.Macaron) {
	...
	m.Group("/install", func() {
		...
		m.Get("/status", func(ctx *macaron.Context) string {
			...
			return jsonResp.Success("", app.Registered)
		})
	})
